@extends('layouts.app')
@section('titulo')
   Parametros / Monitor / Resoluciones / Crear 
@endsection
@section('enlaces')
    <a href="{{route('parametros.index')}}" class="font-bold text-gray-600">Parametros /</a>  <a href="{{route('monitorResolutions.index')}}" class="font-bold text-gray-600">Monitor / Resoluciones</a> / Crear
@endsection
@section('contenido')
    <div class="px-5 ">
        <form action="">            
            <div class="grid  bg-white shadow-lg p-5">
                <div class="mb-5">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="name" name="name" type="text" placeholder="Ingrese Resolución">
                    <p class="text-red-500 text-xs italic">Debe ingresar la resolución</p>
                </div> 
