    ...
    <div class="grid md:grid-cols-2 xl:grid-cols-4 gap-4 px-5 mb-5">
        <div class=" bg-red-500 text-center p-5 rounded-sm">
            ...
            <p class="flex items-center">
               ...
               <span class="text-6xl text-white font-bold">1,500</span>
            </p>
        </div>
            ...
            <div class="bg-red-500 text-center p-5 rounded-sm">
                ...
                <div class="flex justify-between pt-5 gap-4">
                    <div class="w-1/4">
                        ...
                        <p class="text-sm text-gray-600 font-bold bg-white p-2">50</p>
                    </div>
                    <div class="w-1/4">
                        <p  class="text-sm text-gray-600 font-bold bg-white px-3 uppercase mb-1">Graficas</p>
                        <p class="text-sm text-gray-600 font-bold bg-white p-2">50</p>
                    </div>
                    <div class="w-1/4">
                        <p  class="text-sm text-gray-600 font-bold bg-white px-2 uppercase mb-1">Graficas</p>
                        <p class="text-sm text-gray-600 font-bold bg-white p-2">50</p>
                    </div>
                    <div class="w-1/4">
        ...
        <div class="shadow-lg bg-white p-5 mb-2">
            ...
            <ul> 
                ...
                <li class="flex items-center gap-2 mb-3">
                    ...
                    <div class="w-1/2">
                        <a href="" class="font-bold">Armando Rodriguez</a>
                        <p class="text-xs text-gray-500">Técnico</p>
                        <p class="text-xs text-gray-500">10 registros</p>
                    </div>
                </li>  
                <hr>
                <li class="flex items-center gap-2 mb-3">
                    ...
                    <div class="w-1/2">
                        <a href="" class="font-bold">Luis figueroa</a>
                        <p class="text-xs text-gray-500">Técnico</p>
                        <p class="text-xs text-gray-500">40 registros</p>
                    </div>
                </li>
                <hr>
                <li class="flex items-center gap-2 mb-3">
                    ...
                    <div class="w-1/2">
                        <a href="" class="font-bold">leopoldo pinedo</a>
                        <p class="text-xs text-gray-500">Técnico</p>
                        <p class="text-xs text-gray-500">30 registros</p>
                    </div>
                </li> 
                <hr>       
            </ul> 
