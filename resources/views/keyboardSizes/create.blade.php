...
@section('contenido')
    <div class="px-5 ">
        <form action="{{route('keyboardSizes.store')}}" method="POST">   
            @csrf         
            <div class="grid  bg-white shadow-lg p-5">
                <div class="mb-5">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border @error('name') border-red-500 @enderror rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="name" name="name" type="text" placeholder="Ingrese un tamaño">
                    @error('name')
                        <p class="text-red-500 text-xs italic">Debe ingresar un tamaño de teclado</p>
                    @enderror
                </div> 
