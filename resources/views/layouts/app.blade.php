    ...
    <nav id="menuHorizontal" class="hidden sm:block fixed sm:w-3/6 md:w-2/5 lg:w-80 h-screen  bg-zinc-800 overflow-auto " >
      ...
      <ul class="mb-5 text-gray-400"> 
        ...
        @if(auth()->user()->validaRolAdministrador())
          <li class="flex justify-between p-3 items-center {{Route::is('parametros.index') || 
                                                              Route::is('brands.index') || 
                                                              Route::is('brands.show') || 
                                                              Route::is('brands.create') || 
                                                              Route::is('conectores.index') || 
                                                              Route::is('conectores.show') || 
                                                              Route::is('conectores.create') || 
                                                              Route::is('conexiones.index') || 
                                                              Route::is('conexiones.show') || 
                                                              Route::is('conexiones.create') ||
                                                              Route::is('monitorResolutions.index') || 
                                                              Route::is('monitorResolutions.show') || 
                                                              Route::is('monitorResolutions.create') ||
                                                              Route::is('monitorFrames.index') || 
                                                              Route::is('monitorFrames.show') || 
                                                              Route::is('monitorFrames.create') ||
                                                              Route::is('monitorSizes.index') || 
                                                              Route::is('monitorSizes.show') || 
                                                              Route::is('monitorSizes.create') ||
                                                              Route::is('keyboardModels.index') || 
                                                              Route::is('keyboardModels.show') || 
                                                              Route::is('keyboardModels.create') ||
                                                              Route::is('keyboardSizes.index') || 
                                                              Route::is('keyboardSizes.show') || 
                                                              Route::is('keyboardSizes.create') ?'text-gray-50 bg-zinc-900 border-l-4 border-green-300':'border-l-4 border-zinc-800	 hover:border-l-4 hover:border-green-300 hover:text-white cursor-pointer'}}">
        ...
        @if(auth()->user()->validaRolAdministrador())
          <li class="flex justify-between p-3 items-center {{Route::is('usuarios.index') || 
                                                              Route::is('usuarios.show') ||
                                                              Route::is('usuarios.create') ?'text-gray-50 bg-zinc-900 border-l-4 border-green-300':'border-l-4 border-zinc-800	 hover:border-l-4 hover:border-green-300 hover:text-white cursor-pointer'}}">    
        ...
        @endif
        <li class="flex justify-between p-3 items-center {{Route::is('equipments.index')|| 
                                                            Route::is('equipments.show') ||
                                                            Route::is('equipments.create') ?'text-gray-50 bg-zinc-900 border-l-4 border-green-300':'border-l-4 border-zinc-800	 hover:border-l-4 hover:border-green-300 hover:text-white cursor-pointer'}}">        
          <a href="{{route('equipments.index')}}" class=" font-bold uppercase">Workstations</a>
        ...
        <li class="flex justify-between p-3 items-center {{Route::is('componentes.index') || 
                                                            Route::is('monitores.index') ||
                                                            Route::is('monitores.show') ||
                                                            Route::is('monitores.create') || 
                                                            Route::is('teclados.index') ||
                                                            Route::is('teclados.show') ||
                                                            Route::is('teclados.create') || 
                                                            Route::is('ratones.index') ||
                                                            Route::is('ratones.show') ||
                                                            Route::is('ratones.create') || 
                                                            Route::is('rams.index') ||
                                                            Route::is('rams.show') ||
                                                            Route::is('rams.create') || 
                                                            Route::is('disks.index') ||
                                                            Route::is('disks.show') ||
                                                            Route::is('disks.create') || 
                                                            Route::is('processors.index') ||
                                                            Route::is('processors.show') ||
                                                            Route::is('processors.create') || 
                                                            Route::is('computers.index') ||
                                                            Route::is('computers.show') ||
                                                            Route::is('computers.create') ||
                                                            Route::is('laptops.index') ||
                                                            Route::is('laptops.show') ||
                                                            Route::is('laptops.create')  ?'text-gray-50 bg-zinc-900 border-l-4 border-green-300':'border-l-4 border-zinc-800	 hover:border-l-4 hover:border-green-300 hover:text-white cursor-pointer'}}">
