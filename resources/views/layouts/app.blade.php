  ...
  @auth
    <nav id="menuHorizontal" class="hidden sm:block fixed sm:w-3/6 md:w-2/5 lg:w-80 h-screen  bg-zinc-800 overflow-auto " >
      ...
      <ul class="mb-5 text-gray-400"> 
        ...
        @endif
        <li class="flex justify-between p-3 items-center {{Route::is('equipments.index') ?'text-gray-50 bg-zinc-900 border-l-4 border-green-300':'border-l-4 border-zinc-800	 hover:border-l-4 hover:border-green-300 hover:text-white cursor-pointer'}}">        
