@extends('layouts.app')
@section('titulo')
   Componentes / Teclados / Crear 
@endsection
@section('enlaces')
    <a href="{{route('componentes.index')}}" class="font-bold text-gray-600">Componentes /</a>  <a href="{{route('teclados.index')}}" class="font-bold text-gray-600">Teclados</a> / Crear
@endsection
@section('contenido')
    <div class="px-5 ">
        <form action="{{route('teclados.store')}}" method="POST" enctype="multipart/form-data">         
            @csrf   
