        ...
        <form action="">            
            <div class="grid  bg-white shadow-lg p-5">
                <div class="mb-5">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="name" name="name" type="text" placeholder="Ingrese un modelo">
